...
| [14-bovw.md](14-bovw.md) | Methodology → representations; Table 1; **the layout measurement (§9)**; **preprocessing-vs-normalisation pattern (§11.1, feeds 9.7)**; demo 6.6; blur panel (9.5); §11 premise | 6.1–6.5 + 6.5b complete (reported config in §11); 6.6 written, not run |
