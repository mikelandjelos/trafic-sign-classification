...
{\Large \textbf{Poređenje reprezentacija slike za prepoznavanje saobraćajnih znakova: analiza tačnosti, robusnosti i efikasnosti}}\\[1.2cm]
...
\textbf{Naziv projekta:} \textit{Poređenje reprezentacija slike za prepoznavanje saobraćajnih znakova: analiza tačnosti, robusnosti i efikasnosti.}
...
Jedan element projekta je ipak svesno oblikovan tako da služi budućem povezivanju sa modulom M1: \mvp{merenje osetljivosti klasifikatora na pomeraj i promenu razmere graničnog okvira} (opisano u odeljku 6). Realan detektor nikada ne daje isečke tako precizno centrirane i uokvirene kao ručna anotacija, pa ovo merenje kvantifikuje koliko bi tačnosti bilo izgubljeno kada bi se modul M3 spojio sa modulom M1.
...
Test skup se evaluira u čistom obliku i pod četiri tipa kontrolisane degradacije, svaki na pet nivoa jačine:
...
\begin{enumerate}
  ...
  \item \mvp{\textbf{Pomeraj graničnog okvira}} -- perturbacija okvira za $\{0, 10, 20, 30, 40\}\%$ po razmeri i položaju.
\end{enumerate}

Četvrta degradacija zaslužuje posebno objašnjenje. Ona se \textbf{ne} realizuje veštačkim dopunjavanjem ivica, već ponovnim isecanjem iz izvorne slike sa pomerenim koordinatama okvira -- što je moguće upravo zato što GTSRB anotacija sadrži koordinate okvira unutar isečka. Posledica je da pri većim pomerajima u isečak ulazi stvarna pozadina, tačno kao što bi se desilo sa izlazom realnog detektora. Ovo merenje je, kao što je objašnjeno u odeljku 4.1, direktna priprema za buduće povezivanje sa modulom M1.
...
\begin{itemize}
  ...
  \item \textbf{krive robusnosti} -- tačnost u funkciji nivoa svake od četiri degradacije;
